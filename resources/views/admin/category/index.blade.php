                            ...
                            <x-table>
                                <x-slot name="thead">
                                    <x-table.tr>
                                        ...
                                        <x-table.th>Принадлежит категории</x-table.th>
                                        <x-table.th>Постов</x-table.th>
                                        <x-table.th>Создана</x-table.th>
                                ...
                                @foreach($categories as $category)
                                    <x-table.tr>
                                        ...
                                        <x-table.td>{{ $category->created_at->translatedFormat('F d, Y') }}</x-table.td>
